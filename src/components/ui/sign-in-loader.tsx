        ...
        <div className="relative group">
          ...
          <div className="relative bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8">
            ...
            <div className="space-y-6">
              <div>
                <div className="w-32 h-4 bg-gradient-to-r from-gray-700 to-gray-800 rounded mb-2 animate-pulse"></div>
                <div className="w-full h-12 bg-gradient-to-r from-gray-800/50 to-gray-900/50 rounded-xl animate-pulse"></div>
              </div>

              <div>
                <div className="w-24 h-4 bg-gradient-to-r from-gray-700 to-gray-800 rounded mb-2 animate-pulse"></div>
                <div className="w-full h-12 bg-gradient-to-r from-gray-800/50 to-gray-900/50 rounded-xl animate-pulse"></div>
              </div>
            ...
            <div className="text-center mt-8">
              <div className="flex items-center justify-center gap-2 text-orange-400">
                ...
                <span className="text-lg font-medium">Loading ShadowSpeak...</span>
              </div>
            </div>
          </div>
        </div>
